...
westSprite = s_Soldier_Laser_West // west facing sprite
northwestSprite = s_Soldier_Laser_NorthWest // north west facing sprite
southwestSprite = s_Soldier_Laser_SouthWest // south west facing sprite
