// @func: unitDialog
// @description: This is called during a unit's draw function and draws the info dialog above the unit if it's selected
//				 If it isn't selected, then show the health of the unit
// @Author: Kai Mizuno
